...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `${validate_component(MateriLayout, "MateriLayout").$$render(
    $$result,
    {
      linkEvaluasi: "https://docs.google.com/forms/d/e/1FAIpQLSfzgmovxA_6aUeELAdrXzDiHhzSPmni25S11R1DZaaQ1cAHdQ/viewform?embedded=true"
    },
    {},
    {
      default: () => {
