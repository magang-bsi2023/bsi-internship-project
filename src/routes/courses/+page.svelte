	...
	>
		<AccordionItem class="">
			...
			>
				...
				<div>
					<a href="/courses/judul3">Judul 3</a>
				</div>
			</div>
		</AccordionItem>
		<AccordionItem class="">
			...
			<div
				class="-mx-1 -my-5 divide-y dark:divide-gray-500 [&>*]:py-3 [&>div>a]:text-green-500 hover:[&>div>a]:underline"
			>
				<div>
					<a href="/courses/judul1">Judul 1</a>
				</div>
				<div>
					<a href="/courses/judul2">Judul 2</a>
				</div>
