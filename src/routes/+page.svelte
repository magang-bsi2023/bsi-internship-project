...
<div class="my-5">
	<form method="GET" action="/buku"> <!-- on:submit|preventDefault={onSubmit} -->
		...
		<Input size="lg" type="search" name="q" placeholder="Cari buku..."
		...
		<Button type="submit" color="" class="bg-bsigreen text-white hover:bg-bsidgreen">
			Cari
		</Button>
		</ButtonGroup>
	</form>
